...
public class VentaController {
    ...
    @Operation(summary = "Guarda las ventas", description = "Permite guardar la venta ")
    @PostMapping
    ...
    @Operation(summary = "Actualiza las ventas", description = "Permite Actualizar las ventas")
    @PutMapping("/{id}")
    ...
    @Operation(summary = "Lista las ventas", description = "Permite mostrar las ventas por parametros")
    @GetMapping
